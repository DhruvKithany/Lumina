...
Displays:
- Custom Stability meter (circular/arc)
- Gaze duration and "Gaze Lost" indicator + 2D Gaze Tracker
- Optional probe text that fades in/out
...
class StabilityGauge(QWidget):
    ...
    def set_value(self, value: float, high_entropy: bool, fps: float, last_frame_ok: bool):
        self.value = value
...
class GazeTracker(QWidget):
    ...
    def set_gaze(self, yaw: float, pitch: float, gaze_lost: bool, duration: float, mode: str):
        self.yaw = yaw
        self.pitch = pitch
...
class HUDOverlay(QWidget):
    ...
    def _refresh_from_state(self) -> None:
        ...
        self._gaze_tracker.set_gaze(
            ...
            snap["presentation_mode"]
        )
        
        # Handle probe animation
